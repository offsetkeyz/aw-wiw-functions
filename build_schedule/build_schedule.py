...
def main():
    ...
    # bs_methods.delete_all_shifts_for_user(token, datetime.datetime(2022,5,1).astimezone(pytz.timezone('UTC')),bs_methods.get_user_id_from_email(token, 'vinny.frias@arcticwolf.com'))
